                    ...
                    <Table size="medium" aria-label="simple table">
                        <TableBody>
                            <TableRow sx={{ '& td, & th': { border: 0 } }}>
                                ...
                                <TableCell>
                                    <Typography variant="body1" component={Link} to={`/listing/person/${transaction?.payer?._id}`}>
                            ...
                            <TableRow sx={{ '& td, & th': { border: 0 } }}>
                                ...
                                <TableCell>
                                    <Typography variant="body1" component={Link} to={`/listing/person/${transaction?.recipient?._id}`}>
