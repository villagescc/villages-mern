...
exports._create = async (notificationType, notifierId, recipientId, amount, memo) => {
  const notification = await Notification.create({ notificationType, notifierId, recipientId, amount, memo });
  return notification;
}
...
exports.create = async (req, res, next) => {
  ...
  try {
    const notification = await this._create(notificationType, notifierId, recipientId, amount, memo);
